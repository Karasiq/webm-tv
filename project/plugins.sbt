...
if (/* ProjectDefs.scalaJSIs06 */ false)
  Seq(
    ...
    addSbtPlugin("com.github.karasiq"                % "sbt-scalajs-bundler-sjs06" % "1.3.2-SNAPSHOT")
  )
else
  Seq(
    ...
    addSbtPlugin("com.github.karasiq"                % "sbt-scalajs-bundler" % "1.3.2-SNAPSHOT")
  )
